...
echo
echo -e "\e[033mLaunching Ping Sweep and Generating a Target List\e[0m"
...
echo "Launching Scan"
echo
nmap -iL targets.txt -mtu 24 -T4 -Pn -sS -A -r -p- --open --max-retries 0 -vvvv -oA /home/kali/Desktop/nmap-collector/nmapscan
echo
echo
