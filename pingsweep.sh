...
echo
echo
nmap --stats-every=1m -T4 -Pn -vvvv -sCV -p- --open --script http-screenshot --min-rate=256 --min-hostgroup=256 --min-parallelism=256 --max-retries 0 -oA /home/kali/Desktop/testing/$FILE1 --stylesheet nmap-bootstrap.xsl $SUBNET
echo
